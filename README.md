# Разработка REST API для социальной сети блогеров
### Описание 
API сервис для проекта [социальной сети блогеров](https://github.com/shustrov19/soc_net_blogers_api). Благодаря этому проекту через запросы к API можно получать данные от соцсети: посты, комментарии, группы, подписки. Аутентификация пользователей происходит через JWT-токен.
### Технологии 
